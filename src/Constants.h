...
#define GAME_APP_ALT   "Auto juke 1.2.1 web mobile"
#define GAME_APP_NAME  "Auto juke 1.2.1 web"
#define GAME_APP_TITLE "Auto juke"
#elif defined CC_BUILD_ANDROID
#define GAME_APP_NAME  "Auto juke 1.2.1 android alpha"
#define GAME_APP_TITLE "Auto juke 1.2.1 android alpha"
#else
#define GAME_APP_NAME  "Auto juke 1.2.1"
#define GAME_APP_TITLE "Auto juke 1.2.1"
#endif
